...
let overrides = 
  { argonaut-codecs =
      upstream.argonaut-codecs // { version = "v6.1.0" }
    , argonaut-generic =
      upstream.argonaut-generic // { version = "v5.0.0"}
    , argonaut-traversals =
      upstream.argonaut-traversals // { version = "v7.0.0"}
    , argonaut =
      upstream.argonaut // { version = "v6.0.0"}
  }
